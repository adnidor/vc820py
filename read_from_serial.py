...
def handle_message(message): 
    ...
    csv_writer.writerow([elapsed_time,message.number,message.unit,battery_low])
...
#serial_port = serial.Serial("/dev/ttyUSB0", baudrate=2400, parity='N', bytesize=8, timeout=1)
